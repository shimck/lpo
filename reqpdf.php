...
class PDF extends FPDF
{
	...
	$costcentre = $_POST['reqcategory'];
	//$account = $_POST['account'];
	$reqno = '000' . rand(8000,8999);
	...
	$pdf->Cell(30,15,'REQUISITION REQUEST',0,0,'C');
	$pdf->Ln();
...
$date = date('d/m/20y');
	...
	$pdf->Cell(35,15,'Location:',0,0,'');
	$pdf->SetFont('Arial','',12);
	$pdf->Cell(98,15,$location,0,0);
	$pdf->SetFont('Arial','B',12);
	...
	$pdf->Ln();
	$pdf->SetFont('Arial','B',12);
	$pdf->Cell(35,1,'Cost Centre: ',0,0,'');
	$pdf->SetFont('Arial','',12);
	$pdf->Cell(98,1,$costcentre,0,0);
	$pdf->SetFont('Arial','B',12);
	$pdf->Cell(42,1,'Requisition Number:  ','',0,'');
	$pdf->SetFont('Arial','',12);
	$pdf->Cell(100,1,$reqno,30,30);	//for demo use random number
...
//lpo demo
	...
	// $pdf->Ln();
	// $pdf->SetFont('Arial','B',12);
	// $pdf->Cell(35,15,'ACCOUNT:',0,0,'');
	// $pdf->SetFont('Arial','',12);
	// $pdf->Cell(30,15,$account,0,0);
	...
	//$pdf->Cell(25,10,'GHS 42,030',0,0,'R');
	$pdf->Ln();
	$pdf->SetFont('Arial','B',11);
